...
function toggleSkillFrontmatter(text, disable) {
  // BOM strip BEFORE the startsWith('---') check: a BOM'd skill file would
  // be misread as frontmatter-less and get a SECOND header prepended,
  // corrupting it on every enable/disable toggle.
