...
export function listMcp(cwd = process.cwd()) {
  ...
  if (fs.existsSync(manifest)) {
    ...
    // Array.isArray, NOT `|| []`: a poisoned/odd file can parse to a truthy
    // OBJECT, and `for...of` on it throws "is not iterable" — which took down
    // BOTH the Skills and MCP tabs (they share the `list` RPC) on 2026-08-27.
